...
extern "C" {
     ...
     */
    struct xnet_parsed_url * xnet_parse_url(const char *);
    void xnet_parsed_url_free(struct xnet_parsed_url *);
 ...
 */
struct xnet_parsed_url *
xnet_parse_url(const char *url)
{
    struct xnet_parsed_url *purl;
    const char *tmpstr;
    const char *curstr;
    int len;
    int i;
    ...
    purl = malloc(sizeof(struct xnet_parsed_url));
    if ( NULL == purl ) {
        return NULL;
    }
    purl->scheme = NULL;
 ...
 */
void
xnet_parsed_url_free(struct xnet_parsed_url *purl)
{
    if ( NULL != purl ) {
        if ( NULL != purl->scheme ) {
            free(purl->scheme);
